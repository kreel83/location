...
Route::middleware('guest')->group(function () {
    ...
    //             ->name('login');
                ...
                Route::get('login', function() {return 'coucou';})
                ->name('login');
    ...
    Route::get('validation/{token}', [RegisteredUserController::class, 'validation'])
                ->name('register_validation');

    Route::get('final', [RegisteredUserController::class, 'final'])
                ->name('register_final');
});
