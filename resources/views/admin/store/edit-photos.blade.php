    ...
    @if($store)
        ...
        <div class="card mb-3">
            ...
            <div class="card-header text-bg-info text-white">
                Bandeau haut - Dimensions : 1900 x 200 pixels
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a class="btn btn-danger btn-sm" href="{{ route('admin.store.logo.remove', ['store_id' => $store->id]) }}">Supprimer la photo</a>
                    </div>
                </div>
        ...
        <div class="card mb-3">
            ...
            <div class="card-header text-bg-info text-white">
                Photo illustration 1 - Dimensions : 500 x 500 pixels
            </div>
        ...
        <div class="card mb-3">
            ...
            <div class="card-header text-bg-info text-white">
                Photo illustration 2 - Dimensions : 500 x 500 pixels
            </div>
